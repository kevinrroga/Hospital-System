...
if (isset($_POST['docsub'])) {
    if (Doctor::getDoctorByEmail($_POST['email'])) {
        ...
        if ($_POST['password']==$_POST['cpassword']){
            $doctor = new Doctor($_POST['name'], $_POST['surname'], $_POST['father_name'], $_POST['birth_year'], $_POST['gender'], $_POST['telephone'], $_POST['specialization'], $_POST['email'], $_POST['password']); //['name', 'surname', 'father_name', 'birth
